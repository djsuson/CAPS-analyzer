...
***************************************************************************/
#ifndef _PROJMAPPER_H_
#define _PROJMAPPER_H_
...
class PROJMapper : public Mapper {

  public:
    PROJMapper();
    PROJMapper(PROJMapper* from);
    ~PROJMapper();

    /**
     * Specific mapping routine use PROJ map projections
     **/
    ...
    /**
     * PROJ selected map projection
     **/
    PJ*  projection() {return m_projection;}
    void projection(PJ* selection) {m_projection = selection;}

    /**
     * PROJ geodetic coordinate projection
     **/
    PJ*  geodetic() {return m_geodetic;}
    void geodetic(PJ* selection) {m_geodetic = selection;}

    /**
     * PROJ transformation projection
     **/
    PJ*  projTransform() {return m_projTransform;}
    void projTransform(PJ* transformer) {m_projTransform = transformer;}
